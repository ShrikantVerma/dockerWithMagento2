...
class Thread extends BaseThread
{
     ...
     * Add metadatum
     *
     * @param \Cocorico\MessageBundle\Entity\ThreadMetadata $metadatum
     *
     * @return Thread
     */
    public function addMetadatum(\Cocorico\MessageBundle\Entity\ThreadMetadata $metadatum)
    {
     ...
     * @param \Cocorico\MessageBundle\Entity\ThreadMetadata $metadatum
     */
    public function removeMetadatum(\Cocorico\MessageBundle\Entity\ThreadMetadata $metadatum)
    {
