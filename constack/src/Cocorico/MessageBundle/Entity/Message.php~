...
class Message extends BaseMessage
{
     ...
     * Add metadatum
     *
     * @param \Cocorico\MessageBundle\Entity\MessageMetadata $metadatum
     *
     * @return Message
     */
    public function addMetadatum(\Cocorico\MessageBundle\Entity\MessageMetadata $metadatum)
    {
     ...
     * @param \Cocorico\MessageBundle\Entity\MessageMetadata $metadatum
     */
    public function removeMetadatum(\Cocorico\MessageBundle\Entity\MessageMetadata $metadatum)
    {
