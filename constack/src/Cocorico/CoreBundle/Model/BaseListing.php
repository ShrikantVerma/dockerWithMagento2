...
abstract class BaseListing
{
	...
	//# MGONZALEZ MODIFICATIONS
	/**
     * @ORM\Column(name="price_labour", type="decimal", precision=8, scale=0, nullable=true)
     *
     * @var integer
     */
    protected $priceLabour;		
   //# MGONZALEZ END	
     ...
     * Set priceLabour
     *
     * @param string $priceLabour
     *
     * @return Listing
     */
    public function setPriceLabour($priceLabour)
    {
     ...
     * @return string
     */
    public function getPriceLabour()
    {
        return $this->priceLabour;
    }

    /**
     * Get priceLabourDecimal
     *
     * @return float
     */
    public function getPriceLabourDecimal()
    {
        return $this->priceLabour / 100;
     ...
     * @return float
     */
    public function getAmountLabourFeeAsOffererDecimal($LabourfeeAsOfferer)
    {
        return $this->getPriceLabourDecimal() * $LabourfeeAsOfferer;
    }
     ...
     * @return float
     */
    public function getAmountToPayToLabourOffererDecimal($LabourfeeAsOfferer)
    {
        return $this->getPriceLabourDecimal() - $this->getAmountLabourFeeAsOffererDecimal($LabourfeeAsOfferer);
    }
