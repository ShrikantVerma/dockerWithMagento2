...
class ListingCharacteristic extends BaseListingCharacteristic
{
    ...
    /* #DLEVASSEUR - Ajout isfilter qui permet d'afficher ou non les caractéristiques dans le filtre de recherche*/

    /**
	 * @var boolean
	 *
	 * @ORM\Column(name="isfilter", type="boolean", options={"default":"0"},nullable=true)
	 */
     private $isfilter;
