...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        include_once $this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5cf90e7e1e680.php';
    }
...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oZvkflFw9x', 0, 'k4drZWbknwPFSpHt19h0GB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZHZQcJMhe8', 0, 'k4drZWbknwPFSpHt19h0GB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Hn03xYpmO-', 0, 'k4drZWbknwPFSpHt19h0GB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.default_entity_manager.delegate'] = $this->createProxy('EntityManager_655e63b', function () {
                return \EntityManager_655e63b::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jms_di_extra.doctrine_integration.entity_manager.file': $value = ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5cf90e7e1e680.php'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5cf90e7e1e680_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
