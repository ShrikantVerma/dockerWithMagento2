...
$c->setOptions(array('login_path' => '/admin/login', 'default_target_path' => '/admin/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
...
$d->setOptions(array('login_path' => '/admin/login', 'failure_path' => '/admin/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
