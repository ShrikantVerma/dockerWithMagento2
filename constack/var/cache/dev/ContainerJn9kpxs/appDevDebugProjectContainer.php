...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        include_once $this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5cf912c9b08d5.php';
    }
...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NNE0UGb6ZI', 0, 'V0d-JmWKqK4A4VMxbhLmky', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->getDoctrine_Dbal_ConnectionFactoryService()) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '172.19.0.2', 'port' => 3306, 'dbname' => 'costocking_dev', 'user' => 'cocorico', 'password' => 'cocorico', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $f, array());
    }
    ...
    {
        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\UrlPackage(array(0 => 'http://192.168.100.171'), new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), ${($_ = isset($this->services['assets.context']) ? $this->services['assets.context'] : $this->getAssets_ContextService()) && false ?: '_'}), array());
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oZvkflFw9x', 0, 'V0d-JmWKqK4A4VMxbhLmky', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZHZQcJMhe8', 0, 'V0d-JmWKqK4A4VMxbhLmky', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Hn03xYpmO-', 0, 'V0d-JmWKqK4A4VMxbhLmky', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
     ...
     *
     * @return \EntityManager5cf912c9b08d5_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        include_once ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5cf912c9b08d5.php');

        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5cf912c9b08d5_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager(${($_ = isset($this->services['doctrine.orm.default_entity_manager.delegate']) ? $this->services['doctrine.orm.default_entity_manager.delegate'] : $this->getDoctrine_Orm_DefaultEntityManager_DelegateService()) && false ?: '_'}, $this);
    }
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.default_entity_manager.delegate'] = $this->createProxy('EntityManager_3082d69', function () {
                return \EntityManager_3082d69::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['router.request_context'] = new \Symfony\Component\Routing\RequestContext('', 'GET', '192.168.100.171', 'http', 80, 443);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jms_di_extra.doctrine_integration.entity_manager.file': $value = ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5cf912c9b08d5.php'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mongodb_server' => 'mongodb://172.19.0.2:27017',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5cf912c9b08d5_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
